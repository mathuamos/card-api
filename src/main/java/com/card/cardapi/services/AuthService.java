...
import com.card.cardapi.dtos.LoginDto;
...
public class AuthService
{
    ...
    public AuthService(UserRepo userRepo, RoleRepo roleRepo, PasswordEncoder passwordEncoder, AuthenticationManager authenticationManager, TokenHelper tokenHelper) {
    ...
    public Map<String, Object> login(LoginDto request, HttpServletRequest httpServletRequest) {
